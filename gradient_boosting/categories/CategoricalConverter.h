#ifndef GRADIENT_BOOSTING_BINARIZATION_CATEGORICALCONVERTER_H_
#define GRADIENT_BOOSTING_BINARIZATION_CATEGORICALCONVERTER_H_
...
class CategoricalConverter {
 public:
  ...
  std::vector<double> GetConvertionResult() const;
 ...
 private:
  ...
  std::vector<double> convertion_result_;
...
#endif  // GRADIENT_BOOSTING_BINARIZATION_CATEGORICALCONVERTER_H_
