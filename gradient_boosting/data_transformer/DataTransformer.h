#ifndef GRADIENT_BOOSTING_DATA_TRANSFORMATOR_DATATRANSFORMATOR_H_
#define GRADIENT_BOOSTING_DATA_TRANSFORMATOR_DATATRANSFORMATOR_H_
...
class DataTransformer {
 ...
 private:
  std::pair<bool, size_t> FindTargetValueIndex(const utils::data_containers::DataContainer& data,
                                               const std::string& target_value_name_) const;
  std::vector <double> GetTargetValues(const utils::data_containers::DataContainer& data,
                                       const std::string& target_value_name_) const;

  void FitTargetValue(const utils::data_containers::DataContainer& data,
                      size_t target_value_index);
  void FitCategorical(size_t index,
                      const std::vector<std::string>& features,
                      const std::vector<double>& target_values);
  void FitNumerical(size_t index,
                    const std::vector<double>& features);

  std::vector<size_t> TransformCategorical(size_t index,
                                           const std::vector<std::string>& features) const;
  std::vector<size_t> TransformNumerical(size_t index,
...
#endif  // GRADIENT_BOOSTING_DATA_TRANSFORMATOR_DATATRANSFORMATOR_H_
